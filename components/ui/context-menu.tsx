/** ARCHIVE: components/ui/context-menu.tsx VERSION: 1.0 PROTOCOLO: MADRID RESONANCE V4.9 MISSION: UI Component INTEGRITY LEVEL: 100% */
"use client"
...
>(({ className, ...componentProperties }, elementReference) => (
  <ContextMenuPrimitive.Separator
    ref={elementReference}
    className={classNamesUtility("-mx-1 my-1 h-px bg-border", className)}
    {...componentProperties}
  />
))
