...
// VERSIÓN DE PRODUCCIÓN FINAL: Con el contrato de props y tipos implícitos corregidos.
...
export default async function PodcastsPage({ searchParams }: { searchParams: { tab: string, view: LibraryViewMode } }) {
  ...
  const currentTab = searchParams.tab || (user ? 'library' : 'discover');
  ...
  return (
    <div className="container mx-auto max-w-7xl py-8 md:py-12 px-4">
      ...
      <LibraryTabs
        defaultTab={defaultTab} // <-- LA CORRECCIÓN QUIRÚRGICA
        user={user}
