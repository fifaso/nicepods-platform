...
serve(async (request: Request) => {
  ...
  try {
    ...
    // Se re-introduce el header `apikey` con la `service_role_key`.
    // Esto satisface la regla de seguridad de la API Gateway de Supabase.
    // La autenticación real sigue siendo el token en el cuerpo.
