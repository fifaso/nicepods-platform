...
CREATE TYPE "public"."category_entity" AS ENUM (
    'aseo_premium',
    'nodo_hidratacion',
    'refugio_climatico',
    'terminal_energia',
...
ALTER TYPE "public"."category_entity" OWNER TO "postgres";


CREATE TYPE "public"."category_mission" AS ENUM (
...
ALTER TYPE "public"."category_mission" OWNER TO "postgres";
...
CREATE TYPE "public"."historical_epoch" AS ENUM (
    'origen_geologico',
    'pre_industrial',
    'siglo_de_oro',
...
ALTER TYPE "public"."historical_epoch" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."points_of_interest" (
    ...
    "author_identification" "uuid",
    "category_mission" "public"."category_mission",
    "category_entity" "public"."category_entity",
    "historical_epoch" "public"."historical_epoch",
...
COMMENT ON TABLE "public"."points_of_interest" IS 'Bóveda NKV: Almacén central de capital intelectual urbano multidimensional.';
...
CREATE TABLE IF NOT EXISTS "public"."point_of_interest_ingestion_buffer" (
    "id" bigint NOT NULL,
    "point_of_interest_identification" bigint,
    "raw_ocr_text" "text",
    "weather_snapshot" "jsonb" DEFAULT '{}'::"jsonb",
    "visual_analysis_dossier" "jsonb" DEFAULT '{}'::"jsonb",
    "sensor_accuracy" double precision,
    "ingested_at" timestamp with time zone DEFAULT "now"(),
    "grounding_analysis_summary" "text"
);


ALTER TABLE "public"."point_of_interest_ingestion_buffer" OWNER TO "postgres";


ALTER TABLE "public"."point_of_interest_ingestion_buffer" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
CREATE OR REPLACE VIEW "public"."vw_map_resonance_active" WITH ("security_invoker"='on') AS
 SELECT "id" AS "identification",
    "name" AS "point_of_interest_name",
    "category_mission",
    "category_entity",
    "historical_epoch",
    "geo_location",
   ...
   FROM "public"."points_of_interest"
  WHERE ((("status")::"text" = 'published'::"text") OR ("is_published" = true));
...
ALTER TABLE ONLY "public"."point_of_interest_ingestion_buffer"
...
ALTER TABLE ONLY "public"."point_of_interest_ingestion_buffer"
    ADD CONSTRAINT "poi_ingestion_buffer_poi_id_fkey" FOREIGN KEY ("point_of_interest_identification") REFERENCES "public"."points_of_interest"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."points_of_interest"
    ADD CONSTRAINT "points_of_interest_author_id_fkey" FOREIGN KEY ("author_identification") REFERENCES "auth"."users"("id");
...
CREATE POLICY "Point_Of_Interest_Public_Discovery" ON "public"."points_of_interest" FOR SELECT USING (((("status")::"text" = 'published'::"text") OR ("is_published" = true)));



CREATE POLICY "Point_Of_Interest_Sovereign_Ingestion" ON "public"."points_of_interest" FOR INSERT WITH CHECK ("public"."is_admin"());
...
GRANT ALL ON TABLE "public"."point_of_interest_ingestion_buffer" TO "anon";
GRANT ALL ON TABLE "public"."point_of_interest_ingestion_buffer" TO "authenticated";
GRANT ALL ON TABLE "public"."point_of_interest_ingestion_buffer" TO "service_role";
